...
assert.sameValue(result.foo, 1, "The value should be {foo: 1}, but the result.foo value is " + result.foo + ".");
assert.sameValue(result.a, 2, "The value should be {a: 2}, but the result.a value is " + result.a + ".");